...
class TestNiceNumberFormat(unittest.TestCase):
    def test_convert_float_to_nice_number(self):
        for number, number_str in NUMBERS_FIXTURE_EN.items():
            self.assertEqual(fmt.nice_number(number), number_str,
                             'should format {} as {} and not {}'.format(
                                 number, number_str, fmt.nice_number(number)))

    def test_specify_denominator(self):
        self.assertEqual(fmt.nice_number(5.5, denominators=[1, 2, 3]),
                         '5 and a half',
                         'should format 5.5 as 5 and a half not {}'.format(
                             fmt.nice_number(5.5, denominators=[1, 2, 3])))
        self.assertEqual(fmt.nice_number(2.333, denominators=[1, 2]),
                         '2.333',
                         'should format 2.333 as 2.333 not {}'.format(
                             fmt.nice_number(2.333, denominators=[1, 2])))

    def test_no_speech(self):
        self.assertEqual(fmt.nice_number(6.777, speech=False),
                         '6 7/9',
                         'should format 6.777 as 6 7/9 not {}'.format(
                             fmt.nice_number(6.777, speech=False)))
        self.assertEqual(fmt.nice_number(6.0, speech=False),
                         '6',
                         'should format 6.0 as 6 not {}'.format(
                             fmt.nice_number(6.0, speech=False)))

    def test_unknown_language(self):
        """ An unknown / unhandled language should return the string
            representation of the input number.
        """
        self.assertEqual(fmt.nice_number(5.5, lang='as-fd'), '5.5',
                         'should format 5.5 as 5.5 not {}'.format(
                             fmt.nice_number(5.5, lang='as-df')))


class TestPronounceNumber(unittest.TestCase):
    def test_convert_int(self):
        self.assertEqual(fmt.pronounce_number(0), "zero")
        self.assertEqual(fmt.pronounce_number(1), "one")
        self.assertEqual(fmt.pronounce_number(10), "ten")
        self.assertEqual(fmt.pronounce_number(15), "fifteen")
        self.assertEqual(fmt.pronounce_number(20), "twenty")
        self.assertEqual(fmt.pronounce_number(27), "twenty seven")
        self.assertEqual(fmt.pronounce_number(30), "thirty")
        self.assertEqual(fmt.pronounce_number(33), "thirty three")

    def test_convert_negative_int(self):
        self.assertEqual(fmt.pronounce_number(-1), "minus one")
        self.assertEqual(fmt.pronounce_number(-10), "minus ten")
        self.assertEqual(fmt.pronounce_number(-15), "minus fifteen")
        self.assertEqual(fmt.pronounce_number(-20), "minus twenty")
        self.assertEqual(fmt.pronounce_number(-27), "minus twenty seven")
        self.assertEqual(fmt.pronounce_number(-30), "minus thirty")
        self.assertEqual(fmt.pronounce_number(-33), "minus thirty three")

    def test_convert_decimals(self):
        self.assertEqual(fmt.pronounce_number(0.05), "zero point zero five")
        self.assertEqual(fmt.pronounce_number(-0.05), "minus zero point zero five")
        self.assertEqual(fmt.pronounce_number(1.234),
                         "one point two three")
        self.assertEqual(fmt.pronounce_number(21.234),
                         "twenty one point two three")
        self.assertEqual(fmt.pronounce_number(21.234, places=1),
                         "twenty one point two")
        self.assertEqual(fmt.pronounce_number(21.234, places=0),
                         "twenty one")
        self.assertEqual(fmt.pronounce_number(21.234, places=3),
                         "twenty one point two three four")
        self.assertEqual(fmt.pronounce_number(21.234, places=4),
                         "twenty one point two three four")
        self.assertEqual(fmt.pronounce_number(21.234, places=5),
                         "twenty one point two three four")
        self.assertEqual(fmt.pronounce_number(-1.234),
    ...
    def test_convert_hundreds(self):
        self.assertEqual(fmt.pronounce_number(100), "one hundred")
        self.assertEqual(fmt.pronounce_number(666), "six hundred and sixty six")
        self.assertEqual(fmt.pronounce_number(1456), "fourteen fifty six")
        self.assertEqual(fmt.pronounce_number(103254654), "one hundred and three "
                                                      "million, two hundred "
                                                      "and fifty four "
                                                      "thousand, six hundred "
                                                      "and fifty four")
        self.assertEqual(fmt.pronounce_number(1512457), "one million, five hundred"
                                                    " and twelve thousand, "
                                                    "four hundred and fifty "
                                                    "seven")
        self.assertEqual(fmt.pronounce_number(209996), "two hundred and nine "
                                                   "thousand, nine hundred "
                                                   "and ninety six")

    def test_convert_scientific_notation(self):
        self.assertEqual(fmt.pronounce_number(0, scientific=True), "zero")
        self.assertEqual(fmt.pronounce_number(33, scientific=True),
                         "three point three times ten to the power of one")
        self.assertEqual(fmt.pronounce_number(299792458, scientific=True),
                         "two point nine nine times ten to the power of eight")
        self.assertEqual(fmt.pronounce_number(299792458, places=6,
                                          scientific=True),
                         "two point nine nine seven nine two five times "
                         "ten to the power of eight")
        self.assertEqual(fmt.pronounce_number(1.672e-27, places=3,
                                          scientific=True),
    ...
    def test_auto_scientific_notation(self):
        self.assertEqual(
            fmt.pronounce_number(1.1e-150), "one point one times ten to the "
                                        "power of negative one hundred "
                                        "and fifty")
        # value is platform dependent so better not use in tests?
        #self.assertEqual(
        #    fmt.pronounce_number(sys.float_info.min), "two point two two times "
        #                                          "ten to the power of "
        #                                          "negative three hundred "
        #                                          "and eight")
        #self.assertEqual(
        #    fmt.pronounce_number(sys.float_info.max), "one point seven nine "
        #                                          "times ten to the power of"
        #                                          " three hundred and eight")

    def test_large_numbers(self):
        self.assertEqual(
            fmt.pronounce_number(299792458, short_scale=True),
            "two hundred and ninety nine million, seven hundred "
            "and ninety two thousand, four hundred and fifty eight")
        self.assertEqual(
            fmt.pronounce_number(299792458, short_scale=False),
            "two hundred and ninety nine million, seven hundred "
            "and ninety two thousand, four hundred and fifty eight")
        self.assertEqual(
            fmt.pronounce_number(100034000000299792458, short_scale=True),
            "one hundred quintillion, thirty four quadrillion, "
            "two hundred and ninety nine million, seven hundred "
            "and ninety two thousand, four hundred and fifty eight")
        self.assertEqual(
            fmt.pronounce_number(100034000000299792458, short_scale=False),
            "one hundred trillion, thirty four thousand billion, "
            "two hundred and ninety nine million, seven hundred "
            "and ninety two thousand, four hundred and fifty eight")
        self.assertEqual(
            fmt.pronounce_number(10000000000, short_scale=True),
            "ten billion")
        self.assertEqual(
            fmt.pronounce_number(1000000000000, short_scale=True),
            "one trillion")
        # TODO maybe beautify this
        self.assertEqual(
            fmt.pronounce_number(1000001, short_scale=True),
            "one million, one")
        self.assertEqual(fmt.pronounce_number(95505896639631893),
        ...
        self.assertEqual(fmt.pronounce_number(10e80, places=1),
                         "one qesvigintillion")
        # TODO floating point rounding issues might happen
        self.assertEqual(fmt.pronounce_number(1.9874522571e80, places=9),
        ...
        self.assertEqual(fmt.pronounce_number(1.00000000000000001e150),
        ...
        # infinity
        self.assertEqual(
            fmt.pronounce_number(sys.float_info.max * 2), "infinity")
        self.assertEqual(
            fmt.pronounce_number(float("inf")),
            "infinity")
        self.assertEqual(
            fmt.pronounce_number(float("-inf")),
            "negative infinity")
    ...
    def test_ordinals(self):
        self.assertEqual(fmt.pronounce_number(1, ordinals=True), "first")
        self.assertEqual(fmt.pronounce_number(10, ordinals=True), "tenth")
        self.assertEqual(fmt.pronounce_number(15, ordinals=True), "fifteenth")
        self.assertEqual(fmt.pronounce_number(20, ordinals=True), "twentieth")
        self.assertEqual(fmt.pronounce_number(27, ordinals=True), "twenty seventh")
        self.assertEqual(fmt.pronounce_number(30, ordinals=True), "thirtieth")
        self.assertEqual(fmt.pronounce_number(33, ordinals=True), "thirty third")
        self.assertEqual(fmt.pronounce_number(100, ordinals=True), "hundredth")
        self.assertEqual(fmt.pronounce_number(1000, ordinals=True), "thousandth")
        self.assertEqual(fmt.pronounce_number(10000, ordinals=True),
                         "ten thousandth")
        self.assertEqual(fmt.pronounce_number(18691, ordinals=True),
                         "eighteen thousand, six hundred and ninety first")
        self.assertEqual(fmt.pronounce_number(1567, ordinals=True),
        ...
        self.assertEqual(fmt.pronounce_number(18e6, ordinals=True),
                         "eighteen millionth")
        self.assertEqual(fmt.pronounce_number(18e12, ordinals=True,
                                          short_scale=False),
                         "eighteen billionth")
        self.assertEqual(fmt.pronounce_number(18e12, ordinals=True),
                         "eighteen trillionth")
        self.assertEqual(fmt.pronounce_number(18e18, ordinals=True,
                                          short_scale=False), "eighteen "
                                                              "trillionth")

# def fmt.nice_time(dt, lang="en-us", speech=True, use_24hour=False,
#              use_ampm=False):
class TestNiceDateFormat(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.test_config = {}
        p = Path(fmt.date_time_format.config_path)
    ...
    def test_convert_times(self):
        ...
        self.assertEqual(fmt.nice_time(dt),
                         fmt.nice_time(dt, "en-us", True, False, False))

        self.assertEqual(fmt.nice_time(dt),
                         "one twenty two")
        self.assertEqual(fmt.nice_time(dt, use_ampm=True),
                         "one twenty two p.m.")
        self.assertEqual(fmt.nice_time(dt, speech=False),
                         "1:22")
        self.assertEqual(fmt.nice_time(dt, speech=False, use_ampm=True),
                         "1:22 PM")
        self.assertEqual(fmt.nice_time(dt, speech=False, use_24hour=True),
                         "13:22")
        self.assertEqual(fmt.nice_time(dt, speech=False, use_24hour=True,
                                   use_ampm=True),
                         "13:22")
        self.assertEqual(fmt.nice_time(dt, use_24hour=True, use_ampm=True),
                         "thirteen twenty two")
        self.assertEqual(fmt.nice_time(dt, use_24hour=True, use_ampm=False),
                         "thirteen twenty two")
    ...
    def test_nice_date(self, formatter=fmt):
        self.fmt = formatter
        for lang in self.test_config:
            ...
            while (self.test_config[lang].get('test_nice_date') and
                ...
                self.assertEqual(p['assertEqual'],
                                 fmt.nice_date(dt, lang=lang, now=now))
                i = i + 1

        # test fall back to english
        dt = datetime.datetime(2018, 2, 4, 0, 2, 3)
        self.assertEqual(fmt.nice_date(
        ...
        for lang in self.test_config:
            for dt in (datetime.datetime(2017, 12, 30, 0, 2, 3) +
                ...
                self.assertTrue(len(fmt.nice_date(dt, lang=lang)) > 0)
    ...
    def test_nice_year(self):
        for lang in self.test_config:
            ...
            while (self.test_config[lang].get('test_nice_year') and
                ...
                self.assertEqual(p['assertEqual'], fmt.nice_year(
        ...
        for lang in self.test_config:
            ...
            for i in range(1, 9999):
                ...
                self.assertTrue(len(fmt.nice_year(dt, lang=lang)) > 0)
                # Looking through the date sequence can be helpful

#                print(fmt.nice_year(dt, lang=lang))

    def test_nice_duration(self):
        self.assertEqual(fmt.nice_duration(1), "one second")
        self.assertEqual(fmt.nice_duration(3), "three seconds")
        self.assertEqual(fmt.nice_duration(1, speech=False), "0:01")
        self.assertEqual(fmt.nice_duration(61), "one minute one second")
        self.assertEqual(fmt.nice_duration(61, speech=False), "1:01")
        self.assertEqual(fmt.nice_duration(5000),
                         "one hour twenty three minutes twenty seconds")
        self.assertEqual(fmt.nice_duration(5000, speech=False), "1:23:20")
        self.assertEqual(fmt.nice_duration(50000),
                         "thirteen hours fifty three minutes twenty seconds")
        self.assertEqual(fmt.nice_duration(50000, speech=False), "13:53:20")
        self.assertEqual(fmt.nice_duration(500000),
                         "five days  eighteen hours fifty three minutes twenty seconds")  # nopep8
        self.assertEqual(fmt.nice_duration(500000, speech=False), "5d 18:53:20")
        self.assertEqual(fmt.nice_duration(datetime.timedelta(seconds=500000),
                                       speech=False),
                         "5d 18:53:20")

    def test_join(self):
        self.assertEqual(fmt.join_list(None, "and"), "")
        self.assertEqual(fmt.join_list([], "and"), "")

        self.assertEqual(fmt.join_list(["a"], "and"), "a")
        self.assertEqual(fmt.join_list(["a", "b"], "and"), "a and b")
        self.assertEqual(fmt.join_list(["a", "b"], "or"), "a or b")

        self.assertEqual(fmt.join_list(["a", "b", "c"], "and"), "a, b and c")
        self.assertEqual(fmt.join_list(["a", "b", "c"], "or"), "a, b or c")
        self.assertEqual(fmt.join_list(["a", "b", "c"], "or", ";"), "a; b or c")
        self.assertEqual(fmt.join_list(["a", "b", "c", "d"], "or"), "a, b, c or d")

        self.assertEqual(fmt.join_list([1, "b", 3, "d"], "or"), "1, b, 3 or d")
