...
class Parser:
    ...
    def match_one(self, query, choices):
        ...
        best = (_choices[0], self.fuzzy_match(query, _choices[0]))
        for c in _choices[1:]:
            score = self.fuzzy_match(query, c)
            if score > best[1]:
                best = (c, score)
    ...
    def extract_numbers(self, text, short_scale=True, ordinals=False, lang=None):
        """
        ...
        """
        try:
            return self.call_localized_function("extract_numbers", lang, locals().items())
        except NotImplementedError as e:
            warn(e.__str__())
            return []


    def extract_number(self, text, short_scale=True, ordinals=False, lang=None):
        ...
        """
        try:
            return self.call_localized_function("extract_number", lang, locals().items())
        except NotImplementedError as e:
            warn(e.__str__())
            return text


    def extract_duration(self, text, lang=None):
        ...
        """
        try:
            return self.call_localized_function("extract_duration", lang,
                                            locals().items())
        except NotImplementedError as e:
            warn(e.__str__())
            return None
    ...
    def extract_datetime(self, text, anchorDate=None, lang=None, default_time=None):
        """
        ...
        try:
            return self.call_localized_function("extract_datetime", lang,
                                            locals().items())
        except NotImplementedError as e:
            warn(e.__str__())
            return text

    def normalize(self, text, lang=None, remove_articles=True):
        ...
        try:
            return self.call_localized_function("normalize", lang, locals().items())
        except NotImplementedError as e:
            warn(e.__str__())
            return text


    def get_gender(self, word, context="", lang=None):
        ...
        """
        try:
            return self.call_localized_function("get_gender", lang, locals().items())
        except NotImplementedError as e:
            warn(e.__str__())
            return None


    def is_fractional(self, input_str, short_scale=True, lang=None):
        """
        ...
        """
        return self.call_localized_function("is_fractional", lang, locals().items())

    def is_ordinal(self, input_str, lang=None):
        """
        ...
        """
        return self.call_localized_function("is_ordinal", lang, input_str)
